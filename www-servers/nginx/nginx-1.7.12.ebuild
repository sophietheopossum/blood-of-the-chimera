...
#geoip2-module (https://github.com/leev/ngx_http_geoip2_module, BSD-2)
HTTP_GEOIP2_MODULE_PV="1.0"
HTTP_GEOIP2_MODULE_P="ngx_http_geoip2_module-${HTTP_GEOIP2_MODULE_PV}"
HTTP_GEOIP2_MODULE_URI="https://github.com/leev/ngx_http_geoip2_module/archive/${HTTP_GEOIP2_MODULE_PV}.tar.gz"
HTTP_GEOIP2_MODULE_WD="${WORKDIR}/ngx_http_geoip2_module-${HTTP_GEOIP2_MODULE_PV}"
...
src_configure() {
	...
	if use nginx_modules_http_geoip2 ; then
                http_enabled=1
		myconf+=" --add-module=${HTTP_GEOIP2_MODULE_WD}"
	fi
...
#	fi
	...
	if use nginx_modules_http_geoip2; then
		docinto ${HTTP_GEOIP2_MODULE_P}
		dodoc "${HTTP_GEOIP2_MODULE_WD}"/README.md
	fi
}
