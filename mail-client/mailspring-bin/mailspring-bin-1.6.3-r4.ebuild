...
src_install() {
	...
	rm usr/share/mailspring/resources/app.asar.unpacked/lib{anonymous,{cram,digest}md5,gs{,sapiv}2,login,ntlm,plain,sasl{2,db},scram}.so{,.2{,.0.25}}
	...
	dosym /usr/lib64/sasl2/libsasl2.so /opt/mailspring-bin/resources/app.asar.unpacked/libsasl2.so
