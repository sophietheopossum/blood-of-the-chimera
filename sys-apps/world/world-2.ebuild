...
IUSE="archive +browser +chrome +composite +composite-gui dev discord +efi +fat firefox flash +fluxbox fslint +gnomekeyring-admin +index irc mail-client +network-tray openbox overlay pdf +processviewer remote-desktop spreadsheet steam +sudo terminal +terminal-fast text-editor +xfs yandex-disk"
S="${WORKDIR}"
...
RDEPEND="
	...
	irc? ( net-irc/kvirc )
	mail-client? ( mail-client/mailspring-bin )
