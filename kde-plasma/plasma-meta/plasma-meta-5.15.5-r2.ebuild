...
+display-manager elogind grub gtk +handbook +legacy-systray +minimal networkmanager pam
plymouth +pm-utils powerdevil +processviewer pulseaudio +sddm sdk systemd text-editor +wallpapers"

REQUIRED_USE="
	?? ( consolekit elogind systemd )
	browser-integration? ( minimal )
	crypt? ( minimal )
"
...
RDEPEND="
	...
	processviewer? ( >=kde-plasma/ksysguard-${PV}:${SLOT} )
	text-editor? ( kde-apps/kate )
