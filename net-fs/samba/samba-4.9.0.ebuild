...
IUSE="acl addc addns ads ceph client cluster cups debug dmapi fam gnutls gpg json
iprint ldap pam profiling-data python quota selinux syslog system-heimdal afs sasl cpu_flags_x86_aes
+system-mitkrb5 systemd test winbind zeroconf lmdb etcd system-ldb snapper zeroconf"
